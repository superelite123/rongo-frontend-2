...
$(document).ready(() => {
  ...
  $('#sdpURL').val(temp[0].split('=')[1])
  $('#applicationName').val(temp[1].split('=')[1])
  $('#streamName').val(temp[2].split('=')[1])
  let state = {
    publishing: false,
    ...
    selectedMic: '',
    settings: {
      sdpURL: temp[0].split('=')[1],
      applicationName: temp[1].split('=')[1],
      streamName: temp[2].split('=')[1],
      audioBitrate: "64",
      audioCodec: "opus",
      videoBitrate: "3500",
      videoCodec: "42e01f",
